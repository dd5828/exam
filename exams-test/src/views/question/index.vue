...
import { page, getById, deleteQuestion } from '@/api/question'
...
const batchDelete = async () => {
  await deleteQuestion(ids.value)
  ElMessage.success('删除成功')
  selectPage() //重新调用分页查询
  console.log('当前选中id', ids.value)
}
//修改
  ...
  <el-card>
    <div>
      ...
      <div style="float: right">
        ...
        <el-button type="danger" @click="batchDelete" :disabled="onDelete">批量删除</el-button>
      </div>
